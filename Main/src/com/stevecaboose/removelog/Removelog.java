...
public class Removelog extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			File x = new File("C:\\Riot Games\\League of Legends\\RADS\\solutions\\lol_game_client_sln\\releases\\0.0.1.94\\deploy\\LogitechLed.dll");
			File y = new File("C:\\Riot Games\\League of Legends\\RADS\\solutions\\lol_game_client_sln\\releases\\0.0.1.94\\deploy\\LogitechGkey.dll");
			//if files on D://
			File q = new File("D:\\Riot Games\\League of Legends\\RADS\\solutions\\lol_game_client_sln\\releases\\0.0.1.94\\deploy\\LogitechLed.dll");
			File r = new File("D:\\Riot Games\\League of Legends\\RADS\\solutions\\lol_game_client_sln\\releases\\0.0.1.94\\deploy\\LogitechGkey.dll");
			//if files on E://
			File a = new File("E:\\Riot Games\\League of Legends\\RADS\\solutions\\lol_game_client_sln\\releases\\0.0.1.94\\deploy\\LogitechLed.dll");
			File b = new File("E:\\Riot Games\\League of Legends\\RADS\\solutions\\lol_game_client_sln\\releases\\0.0.1.94\\deploy\\LogitechGkey.dll");
